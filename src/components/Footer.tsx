...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-indigo-500/10 bg-[#050510]/90 py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="pt-12 border-t border-indigo-500/5 mb-12">
          <h4 className="text-slate-400 text-xs font-bold tracking-[0.2em] uppercase mb-8 text-center bg-gradient-to-r from-transparent via-indigo-500/10 to-transparent py-2">
