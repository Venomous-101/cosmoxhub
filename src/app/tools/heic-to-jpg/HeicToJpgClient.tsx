...
export default function HeicToJpgClient() {
  ...
  const guideSections = [
    {
      title: "How to Use (iOS & Mac)",
      content: "1. Upload your iPhone .heic or .heif files. 2. Choose your preferred destination (JPG, PNG, or WebP). 3. Adjust the quality slider for optimization. 4. Hit 'Execute Elite Blast' to convert locally.",
      icon: HelpCircle
    },
    {
      title: "iPhone Integration",
      content: "Apple's proprietary HEIC format is the default for iOS. Our engine provides a seamless bridge, allowing you to convert these files into standard formats that work on Windows, Android, and web platforms.",
      icon: Smartphone
    },
    {
      title: "Engine Performance",
      content: "We use a high-performance WASM (WebAssembly) memory management system to handle large batches of high-res photos. This ensures your browser remains responsive even during heavy processing.",
      icon: Box
    },
    {
      title: "Privacy Moat",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "HEIC is extremely efficient at preserving detail. Converting to JPG will result in a slightly larger file size, but if you keep the quality slider at 80% or higher, the visual difference is non-existent."
    },
    {
      question: "Can I convert HEIC to PNG instead?",
      answer: "Yes! Our tool supports exporting to JPG, PNG, and WebP, giving you total flexibility for how you want to use your iPhone photos."
    }
  ];
  ...
  return (
    <ToolLayout
      title="HEIC to JPG - Free Online Utility Tool"
