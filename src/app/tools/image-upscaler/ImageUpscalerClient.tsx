...
export default function ImageUpscalerClient() {
  const guideSections = [
    {
      ...
      content: "1. Upload up to 15 images. 2. Select your scale (2x, 3x, or 4x). 3. Choose 'Ultra' for max detail or 'Safe' for speed. 4. Click 'Start Bulk' and download your 4K results.",
      icon: HelpCircle
    },
    {
      title: "How AI Upscaling Works",
      content: "Unlike traditional 'bicubic' resizing which simply stretches pixels, our AI uses ESRGAN (Enhanced Super-Resolution Generative Adversarial Networks) to intelligently predict and reconstruct missing details. It recognizes textures like skin, hair, and landscapes, literally 'redrawing' them at 2x or 4x resolution.",
      icon: Sparkles
    },
    {
      title: "Ultra vs Standard Mode",
      content: "Standard mode is optimized for balanced speed and quality. Ultra mode uses a deeper neural network (Thick ESRGAN) to recover complex textures and eliminate compression artifacts. Note: Ultra mode is significantly more hardware-intensive and requires a modern GPU.",
      icon: Zap
    },
    {
      title: "Hardware Safety Protocols",
      content: "CosmoxHub is unique because it runs 100% in your browser. To prevent crashes, we use a 32px tiling system and an 8K resolution cap. If the AI engine detections a hardware bottleneck, it automatically switches to our 'Elite Canvas' fallback to ensure you always get your result.",
      icon: Settings
    },
    {
      title: "No-Upload Privacy",
      content: "Your professional assets never leave your computer. By using TensorFlow.js, we execute the AI models directly in your browser's VRAM. This is the ultimate privacy standard for sensitive corporate or personal imagery.",
      icon: Lock
    }
  ];
  ...
  const faqs = [
    {
      question: "Why is the first upscale slow?",
      answer: "The first time you click 'Start', the browser must download and compile the AI model (approx 10-25MB). Subsequent upscales will be significantly faster as the model is cached in your browser's memory."
    },
    {
      question: "Is there a file size limit?",
      answer: "We support images up to 4K resolution for AI upscaling. For images larger than 4K, we automatically use our hardware-safe scaling engine to prevent browser crashes."
    },
    {
      question: "What is 'Stability Mode'?",
      answer: "Stability Mode (Safe) bypasses the AI engine and uses high-quality multi-step interpolation. Use this if you are on an older laptop or mobile device that struggles with heavy GPU tasks."
    },
    {
      question: "Are my images stored?",
      answer: "Never. CosmoxHub has no backend storage. Your images exist only in your RAM while the tab is open and are destroyed the moment you close the page."
    }
  ];
  ...
  return (
    <ToolLayout
      title="Image Upscaler - Free Online Utility Tool"
