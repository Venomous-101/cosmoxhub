...
import { Copy, Trash2, ArrowRightLeft, Link } from 'lucide-react';
...
export default function UrlEncoderClient() {
  ...
  return (
    <ToolLayout
      ...
      description="Encode or decode URLs and query strings instantly in your browser. Free, private, no server upload required."
      icon={Link}
      color="#7c3aed"
    >
