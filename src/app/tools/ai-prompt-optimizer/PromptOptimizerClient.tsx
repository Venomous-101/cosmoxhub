    ...
    >
      ...
      <div className="mt-20 border-t border-white/5 pt-20">
        <ToolGuide
          ...
          sections={[
            {
              title: "Input Your Raw Idea",
              content: "Describe the task or objective you want the AI to handle. Be as simple or as detailed as you like—our engine will extract the core intent."
            },
            {
              title: "Select Elite Framework",
              content: "Choose from industry-standard prompt engineering frameworks like RTF, RISEN, or COSTAR to give your request professional structure."
            },
            {
              title: "Target Your AI Model",
              content: "Specify whether you are using ChatGPT, Claude, or Gemini. Our optimizer adjusts the syntax to match the specific strengths of each model."
            },
            {
              title: "Optimize and Deploy",
              content: "Click 'Optimize Prompt' to generate your professional-grade instruction set. Use one-click copy to move it directly into your AI workspace."
            }
          ]}
          faqs={[
            {
              question: "Are my prompt ideas shared with any servers?",
              answer: "Never. CosmoxHub operates on a 'Zero-Server' architecture. Your raw ideas and engineered prompts stay in your browser and are never stored or tracked."
            },
            {
              question: "Which prompt framework should I choose?",
              answer: "RTF (Role-Task-Format) is best for general tasks. COSTAR is excellent for marketing, while RISEN is ideal for complex technical deep-dives."
            },
            {
              question: "Does this tool work for AI image generators?",
              answer: "Yes! Our Creative tone and general frameworks are highly effective for engineering descriptive prompts for Midjourney, DALL-E, and Stable Diffusion."
            }
          ]}
        />

        <div className="mt-20 prose prose-invert max-w-none border border-white/5 bg-white/[0.02] p-12 rounded-[3rem]">
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-8">Master Prompt Engineering with Elite Logic</h2>
